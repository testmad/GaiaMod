...
public class GuiHandler implements IGuiHandler {
		...
		if (entity != null) {
			...
			case ModGui.guiIDGaiaAltar:
				if (entity instanceof TileEntityGaiaAltar) {
					return new ContainerGaiaAltar(player.inventory,
							(TileEntityGaiaAltar) entity);
				}
				return null;

			case ModGui.guiIDEssenceAltar:
				if (entity instanceof TileEntityEssenceAltar) {
					return new ContainerEssenceAltar(player.inventory,
							(TileEntityEssenceAltar) entity);
				}
				return null;

			case ModGui.guiIDOrderShrine:
				if (entity instanceof TileEntityOrderShrine) {
					return new ContainerOrderShrine(player.inventory,
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world,
		...
		if (entity != null) {
			...
			case ModGui.guiIDGaiaAltar:
				if (entity instanceof TileEntityGaiaAltar) {
					return new GuiGaiaAltar(player.inventory,
							(TileEntityGaiaAltar) entity);
				}
				return null;
			...
			case ModGui.guiIDEssenceAltar:
				if (entity instanceof TileEntityEssenceAltar) {
					return new GuiEssenceAltar(player.inventory,
							(TileEntityEssenceAltar) entity);
				}
				return null;
			...
			case ModGui.guiIDOrderShrine:
				if (entity instanceof TileEntityOrderShrine) {
					return new GuiOrderShrine(player.inventory,
							(TileEntityOrderShrine) entity);
				}
				return null;
			}
