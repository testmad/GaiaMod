...
import com.testmad.gaiamod.slots.SlotGaiaAltar;
...
public class ContainerGaiaAltar extends Container {
	...
	public ContainerGaiaAltar(InventoryPlayer invPlayer,
		...
		// result
		this.addSlotToContainer(new SlotGaiaAltar(invPlayer.player, entity, 4,
				116, 35));
