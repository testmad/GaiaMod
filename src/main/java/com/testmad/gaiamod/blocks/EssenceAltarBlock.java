...
public class EssenceAltarBlock extends BlockContainer{
	private Random rand;
	...
	public void registerBlockIcons (IIconRegister iconRegister) {
		...
		this.blockIcon = iconRegister.registerIcon(References.MODIDLOCAL + ":" + (this.isActive ? getUnlocalizedName().substring(5) + "_side" : getUnlocalizedName().substring(5) + "_side" ));
		//this.gaiaAltarFront = iconRegister.registerIcon(References.MODID + ":" + getUnlocalizedName().substring(5) + "_front");
		this.essenceAltarTop = iconRegister.registerIcon(References.MODIDLOCAL + ":" + (this.isActive ? getUnlocalizedName().substring(5) + "_top" : getUnlocalizedName().substring(5) + "_top"));
		//this.gaiaAltarTop = iconRegister.registerIcon(References.MODID + ":" + getUnlocalizedName().substring(5) + "_top");
		this.essenceAltarFront = iconRegister.registerIcon(References.MODIDLOCAL + ":" + (this.isPowered ? getUnlocalizedName().substring(5) + "_front" : (this.isActive ? getUnlocalizedName().substring(5) + "_front" : getUnlocalizedName().substring(5) + "_front")));
	}
