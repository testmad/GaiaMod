...
public class GaiaModEventHandler
{
    ...
    public void onLivingHurt(LivingHurtEvent event)
    {
        ...
        if (event.source.getSourceOfDamage() instanceof EntityArrow &&
        		...
        		|| (hasEquippedSet(attackerEntity, ModArmor.chaosHelmet, ModArmor.chaosChest, ModArmor.chaosLeggings, ModArmor.chaosBoots))
                || (hasEquippedSet(attackerEntity, ModArmor.orderHelmet, ModArmor.orderChest, ModArmor.orderLeggings, ModArmor.orderBoots))))
        {
