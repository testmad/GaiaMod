...
public class GaiaAltarBlock extends BlockContainer {
	...
	public void registerBlockIcons (IIconRegister iconRegister) {
		...
		this.gaiaAltarTop = iconRegister.registerIcon(References.MODIDLOCAL + ":" + (this.isActive ? getUnlocalizedName().substring(5) + "_top" : getUnlocalizedName().substring(5) + "_top"));
		//this.gaiaAltarTop = iconRegister.registerIcon(References.MODID + ":" + getUnlocalizedName().substring(5) + "_top");
		this.gaiaAltarFront = iconRegister.registerIcon(References.MODIDLOCAL + ":" + (this.isPowered ? getUnlocalizedName().substring(5) + "_front" : (this.isActive ? getUnlocalizedName().substring(5) + "_front" : getUnlocalizedName().substring(5) + "_front")));
	}
