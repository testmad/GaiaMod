...
public class OrderShrineBlock extends BlockContainer {
	...
	public void registerBlockIcons (IIconRegister iconRegister) {
		...
		this.orderShrineTop = iconRegister.registerIcon(References.MODID + ":" + getUnlocalizedName().substring(5) + "_top");
		//this.gaiaAltarTop = iconRegister.registerIcon(References.MODID + ":" + getUnlocalizedName().substring(5) + "_top");
		this.orderShrineFront = iconRegister.registerIcon(References.MODID + ":" + (this.isPowered ? getUnlocalizedName().substring(5) + "_front"  : getUnlocalizedName().substring(5) + "_front" ));
	}
