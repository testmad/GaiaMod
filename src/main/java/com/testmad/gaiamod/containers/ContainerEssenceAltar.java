...
import com.testmad.gaiamod.slots.SlotEssenceAltar;
...
public class ContainerEssenceAltar extends Container {
	...
	public ContainerEssenceAltar(InventoryPlayer invPlayer,
		...
		// result
		this.addSlotToContainer(new SlotEssenceAltar(invPlayer.player, entity,
				4, 118, 35));
