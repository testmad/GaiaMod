...
public class ModWeapons {
	...
	static Item.ToolMaterial stormToolMaterial = EnumHelper.addToolMaterial(
			"stormToolMaterial", 3, 2061, 14.0F, 10.0F, 0);

	static Item.ToolMaterial chaosToolMaterial = EnumHelper.addToolMaterial(
			"chaosToolMaterial", 3, 2561, 16.0F, 12.0F, 0);

	static Item.ToolMaterial orderToolMaterial = EnumHelper.addToolMaterial(
			"orderToolMaterial", 3, 3061, 18.0F, 14.0F, 0);
